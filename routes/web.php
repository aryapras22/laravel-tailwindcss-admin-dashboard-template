...
// Route::get('/regulations/{regulation}', [RegulationController::class, 'show'])->name('regulation.show');
// Route::delete('/regulations/{regulation}', [RegulationController::class, 'destroy'])->name('regulation.destroy');
// Route::get('/regulations/{regulation}/edit', [RegulationController::class, 'edit'])->name('regulation.edit');
// Route::put('/regulations/{regulation}', [RegulationController::class, 'update'])->name('regulation.update');
